...
pwd
cp bin/classes2.dex assets/classes2.dex
aapt add -f hello.apk assets/classes2.dex
#aapt add -f hello.apk classes2.dex
 cd Auto-sign
 /Library/Java/JavaVirtualMachines/jdk1.7.0_79.jdk/Contents/Home/bin/java -jar signapk.jar testkey.x509.pem testkey.pk8 ../hello.apk ../hellosign2.apk